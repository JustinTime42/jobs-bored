...
import { getCompanyPeople, getPersonEmail } from "@/src/actions/apolloPeople";
import { useUserContext } from "../../app/context/UserContext";
import { Email, Facebook, Favorite, FavoriteBorder, GitHub, LinkedIn, Twitter } from "@mui/icons-material";
import LinkedInIcon from '@mui/icons-material/LinkedIn';
import LinkIcon from '@mui/icons-material/Link';
import PersonInfo from "../person_info/PersonInfo";
import EmailLink from "../email_link/EmailDownloadLink";
...
const CompanyDetails = ( { company, userId, isActive  }: { company: Organization, userId: string, isActive: boolean }) => {
    ...
    const [ hideMoreButton, setHideMoreButton ] = useState<boolean>(company.fetched_people || false);
